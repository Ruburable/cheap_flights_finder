#!/usr/bin/env python3
"""
Setup script for Flight Deal Bot
...
def main():
    """Interactive setup"""
    print_header("✈️ Flight Deal Bot - Setup Wizard")
    ...
    print("Default: Warsaw (WAW) to São Paulo (GRU) and Rio (GIG)\n")

    origin = get_input("Origin airport code", "WAW")

    print("\nDestinations (Brazilian airports):")
    print("  GRU - São Paulo (Guarulhos)")
